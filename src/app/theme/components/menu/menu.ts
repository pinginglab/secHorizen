...
export const verticalMenuItems = [
    new Menu (100, '首页', 'null', null, 'tachometer', null, false, 0),
    // new Menu (200, '实验课程', null, null, 'folder-open-o', null, true, 0),
    // new Menu (201, '攻击实践课', null, null, 'folder-open-o', null, true, 200),
    // new Menu (301, '靶场列表', null, null, 'folder-o', null, false, 201),
    // new Menu (202, '防御实践课', null, null, 'folder-open-o', null, false, 200),
    // new Menu (302, '靶场列表', null, null, 'folder-o', null, false, 202),
    // new Menu (203, '路径', null, null, 'folder-open-o', null, true, 0),
    // new Menu (301, 'python教学', null, null, 'folder-open-o', null, true, 203),
    // new Menu (301, '云计算', null, null, 'folder-open-o', null, true, 203),
    // new Menu (301, '网络安全', null, null, 'folder-open-o', null, true, 203),
    // new Menu (301, 'wifi攻防', null, null, 'folder-open-o', null, true, 203),
    // new Menu (401, '防火墙', null, null, 'folder-open-o', null, true, 301),
    // new Menu (401, '防火墙', null, null, 'folder-open-o', null, true, 301),
    // new Menu (401, '防火墙', null, null, 'folder-open-o', null, true, 301),
    // new Menu (401, '防火墙', null, null, 'folder-open-o', null, true, 301),
    // new Menu (401, '防火墙', null, null, 'folder-open-o', null, true, 301),
    ...
    new Menu (43, 'Login', '/', null, 'sign-in', null, false, 40),
    ...
    new Menu (200, '友情链接', null, 'https://pinginglab.net', 'external-link', '_blank', false, 0)
];
